...
## features
- [] Ability to factory reset the app. It should delete all the sqlite data, yt-dlp archive data and other logs. It should be like starting fresh. It should warn the user before doing so. It shouldn't delete any downloaded videos. Just the logs. PRD: #16.
